...
for few_num in "${!few_shots[@]}";do
    ...
    meta_path=/data/datasets/pub/public/own_anomaly_detect/metal_meta_d4.json  # metal_own_meta  metal_meta_ksdd metal_meta_d4
    surgery_type=vv_res
    ...
    CUDA_VISIBLE_DEVICES=0 python -u main/get_anomaly_map_base.py --dataset ${dataset_name} \
    ...
    --image_size 518 --patch_size 14 --feature_list 6 12 18 24 --dpam_layer 20 --update_topk 40 --batch_sim_topk 5 --self_sim_topk 100 --score_topk 100 \
    --surgery_type ${surgery_type}  --use_detailed  --visualize
    wait
done


# --update_topk 200 --batch_sim_topk 2500 --self_sim_topk 800 --score_topk 100  casting billet
#--surgery_type vv \
