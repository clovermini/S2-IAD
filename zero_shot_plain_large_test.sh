...
for few_num in "${!few_shots[@]}";do
    ...
    surgery_type=vv_res
    dataset_name=casting_billet  # steel_pipe  # casting_billet  # KolektorSDD2  #metal_own
    ...
    save_dir=./output/exps_${base_name}/${dataset_name}_vit_large_14_518_few_shot_${train_few_shots}_${surgery_type}_training_dual_soft/  # _dino_batch_self_update
...
# --update_topk 40 --batch_sim_topk 5 --self_sim_topk 100 --score_topk 100  # steel pipe
#--surgery_type vv \
