...
class CUSTOMCLIP(nn.Module):
    ...
    def __init__(
        ...
        self.text_use_embedding = False
        if not self.text_use_embedding:
    ...
    def encode_text(self, text, normalize: bool = False, return_tokens=False):
        #if self.text_use_embedding:
        ...
        #print('########## text_projection ', self.text_projection)
...
def convert_weights_to_lp(model: nn.Module, dtype=torch.float16):
    ...
    def _convert_weights(l):
        ...
        if isinstance(l, (CUSTOMCLIP, TextTransformer)):
