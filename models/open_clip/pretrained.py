...
_EVAL14_336 = dict(
    eva_clip=_pcfg(hf_hub='/data/datasets/pub/public/bigmodel_weights/EVA-CLIP/EVA02_CLIP_L_336_psz14_s6B.pt'),
    eva02_clip=_pcfg(hf_hub='/data/datasets/pub/public/bigmodel_weights/EVA-CLIP/EVA02_CLIP_L_336_psz14_s6B.pt'),
    eva_clip_224to336=_pcfg(hf_hub='/data/datasets/pub/public/bigmodel_weights/EVA-CLIP/EVA02_CLIP_L_psz14_224to336.pt'),
    eva02_clip_224to336=_pcfg(hf_hub='/data/datasets/pub/public/bigmodel_weights/EVA-CLIP/EVA02_CLIP_L_psz14_224to336.pt'),
)
...
_PRETRAINED = {
    ...
    "EVA02-L-14-336": dict(
        ...
        merged2b_s6b_b61k=_pcfg(hf_hub='/data/account/liuchuni/code/fsad_big_model/weights/EVA02-L-14-336/'),
    ),
    "EVA02-E-14": dict(
...
def download_pretrained_from_url(
    ...
    print('url ', url, ' download_target ', download_target)
...
def download_pretrained_from_hf(
    ...
    print('model_id ', model_id, ' filename ', filename)  # model_id  apple/DFN5B-CLIP-ViT-H-14-378  filename  open_clip_pytorch_model.bin
...
def download_pretrained(
    ...
    if download_url:
        ...
        print('filename ', filename, ' model_id ', model_id)
        if filename:
